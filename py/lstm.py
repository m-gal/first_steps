...
zero_vars = list(set(train_vars.columns) - set(train_vars.columns[zero_var_filter.get_support()]))
...
df_shift_1.info()
df_shift_1[['(t)date_ym', '(t)target', '(t)consumer_credit_m', '(t-1)target', '(t-1)consumer_credit_m']].head(10)
...
# split on train-test
X_train_1, X_test_1, y_train_1, y_test_1 = train_test_split(df_shift_1.drop(['(t)date_ym', '(t)target'],
                                                                            axis=1),
                                                            df_shift_1['(t)target'],
                                                            test_size=test_size,
                                                            shuffle=shuffle,
...
# view test data
df_shift_1.loc[y_test_1.index, ['(t)date_ym', '(t)target']].sort_values(by=['(t)date_ym'])
...
X_train_scaled_3d_1 = X_train_scaled_1.reshape((X_train_scaled_1.shape[0], 1, X_train_scaled_1.shape[1]))
X_test_scaled_3d_1 = X_test_scaled_1.reshape((X_test_scaled_1.shape[0], 1, X_test_scaled_1.shape[1]))
X_scaled_3d_1 = X_scaled_1.reshape((X_scaled_1.shape[0], 1, X_scaled_1.shape[1]))

print(X_train_scaled_3d_1.shape, y_train_1.shape,
      X_test_scaled_3d_1.shape, y_test_1.shape,
      X_scaled_3d_1.shape, y_1.shape)
...
# df_shift_2.info()
df_shift_2[['(t)date_ym', '(t)target', '(t-1)date_ym', '(t-1)target',
            '(t-2)date_ym', '(t-2)target']].head(10)
...
# split on train-test
X_train_2, X_test_2, y_train_2, y_test_2 = train_test_split(df_shift_2.drop(['(t)date_ym', '(t)target'],
                                                                            axis=1),
                                                            df_shift_2['(t)target'],
                                                            test_size=test_size,
                                                            shuffle=shuffle,
                                                            random_state=random_state)
# view test data
df_shift_2.loc[y_test_2.index, ['(t)date_ym', '(t)target']].sort_values(by=['(t)date_ym'])
# prepare full dataset
...
# reshape input to be 3D [samples, timesteps, features]
X_train_scaled_3d_2 = X_train_scaled_2.reshape((X_train_scaled_2.shape[0], 1, X_train_scaled_2.shape[1]))
X_test_scaled_3d_2 = X_test_scaled_2.reshape((X_test_scaled_2.shape[0], 1, X_test_scaled_2.shape[1]))
X_scaled_3d_2 = X_scaled_2.reshape((X_scaled_2.shape[0], 1, X_scaled_2.shape[1]))

print(X_train_scaled_3d_2.shape, y_train_2.shape,
      X_test_scaled_3d_2.shape, y_test_2.shape,
      X_scaled_3d_2.shape, y_2.shape)
...
# df_shift_3.info()
df_shift_3[['(t)date_ym', '(t)target', '(t-1)date_ym', '(t-1)target',
            '(t-2)date_ym', '(t-2)target', '(t-3)date_ym', '(t-3)target']].head(10)

# drop columns we don't want to predict
names_shift_3 = list('(t-3)' + df.columns)
names_shift_3.extend(list('(t-2)' + df.columns))
names_shift_3.extend(list('(t-1)' + df.columns))
names_shift_3 = [e for e in names_shift_3 if e not in ('(t-3)date_ym', '(t-2)date_ym', '(t-1)date_ym')]
...
df_shift_3[['(t)target', '(t-1)target', '(t-2)target', '(t-3)target']].plot(figsize=(14, 7))
del (names_shift_3)
# --------------------------------------------------------------------------------------------------
# (t-3)(t-2)(t-1):Split Train & Test datasets
# split on train-test
X_train_3, X_test_3, y_train_3, y_test_3 = train_test_split(df_shift_3.drop(['(t)date_ym', '(t)target'],
                                                                            axis=1),
                                                            df_shift_3['(t)target'],
                                                            test_size=test_size,
                                                            shuffle=shuffle,
                                                            random_state=random_state)
# view test data
df_shift_3.loc[y_test_3.index, ['(t)date_ym', '(t)target']].sort_values(by=['(t)date_ym'])
# prepare full dataset
...
# reshape input to be 3D [samples, timesteps, features]
X_train_scaled_3d_3 = X_train_scaled_3.reshape((X_train_scaled_3.shape[0], 1, X_train_scaled_3.shape[1]))
X_test_scaled_3d_3 = X_test_scaled_3.reshape((X_test_scaled_3.shape[0], 1, X_test_scaled_3.shape[1]))
X_scaled_3d_3 = X_scaled_3.reshape((X_scaled_3.shape[0], 1, X_scaled_3.shape[1]))

print(X_train_scaled_3d_3.shape, y_train_3.shape,
      X_test_scaled_3d_3.shape, y_test_3.shape,
      X_scaled_3d_3.shape, y_3.shape)
...
# df_shift_4.info()
df_shift_4[['(t)date_ym', '(t)target', '(t-1)date_ym', '(t-1)target',
            '(t-2)date_ym', '(t-2)target', '(t-3)date_ym', '(t-3)target',
            '(t-4)date_ym', '(t-4)target']].head(10)
...
names_shift_4 = [e for e in names_shift_4 if e not in ('(t-4)date_ym', '(t-3)date_ym',
                                                       '(t-2)date_ym', '(t-1)date_ym')]
names_shift_4.extend(['(t)target', '(t)date_ym'])

df_shift_4 = df_shift_4[names_shift_4]
df_shift_4.info()
df_shift_4[['(t)target', '(t-1)target', '(t-2)target',
            '(t-3)target', '(t-4)target']].plot(figsize=(14, 7))
del (names_shift_4)
# --------------------------------------------------------------------------------------------------
# (t-4)(t-3)(t-2)(t-1):Split Train & Test datasets
# split on train-test
X_train_4, X_test_4, y_train_4, y_test_4 = train_test_split(df_shift_4.drop(['(t)date_ym', '(t)target'],
                                                                            axis=1),
                                                            df_shift_4['(t)target'],
                                                            test_size=test_size,
                                                            shuffle=shuffle,
                                                            random_state=random_state)
df_shift_4[['(t)date_ym', '(t)target', '(t-1)target', '(t-1)consumer_credit_m',
            '(t-2)target', '(t-1)consumer_credit_m',
            '(t-3)target', '(t-3)consumer_credit_m']].head(10)
# view test data
df_shift_4.loc[y_test_4.index, ['(t)date_ym', '(t)target']].sort_values(by=['(t)date_ym'])
# prepare full dataset
...
# reshape input to be 3D [samples, timesteps, features]
X_train_scaled_3d_4 = X_train_scaled_4.reshape((X_train_scaled_4.shape[0], 1, X_train_scaled_4.shape[1]))
X_test_scaled_3d_4 = X_test_scaled_4.reshape((X_test_scaled_4.shape[0], 1, X_test_scaled_4.shape[1]))
X_scaled_3d_4 = X_scaled_4.reshape((X_scaled_4.shape[0], 1, X_scaled_4.shape[1]))

print(X_train_scaled_3d_4.shape, y_train_4.shape,
      X_test_scaled_3d_4.shape, y_test_4.shape,
      X_scaled_3d_4.shape, y_4.shape)
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_dense_1 = [model, history, pred, score_train, score_test, score_dev, '(t-1)VANILLA DENSE']
## view process
...
for r in range(result_range):
    ...
    print('DENSE 1: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_dense_2 = [model, history, pred, score_train, score_test, score_dev, '(t-2)VANILLA DENSE']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('DENSE 2: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_dense_3 = [model, history, pred, score_train, score_test, score_dev, '(t-3)VANILLA DENSE']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('DENSE 3: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_dense_4 = [model, history, pred, score_train, score_test, score_dev, '(t-4)VANILLA DENSE']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('DENSE 4: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_densest_1 = [model, history, pred, score_train, score_test, score_dev, '(t-1)STACKED 3 DENSE']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('STACKED DENSE 1: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_densest_2 = [model, history, pred, score_train, score_test, score_dev, '(t-2)STACKED 3 DENSE']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('STACKED DENSE 2: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_densest_3 = [model, history, pred, score_train, score_test, score_dev, '(t-3)STACKED 3 DENSE']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('(in loop)STACKED DENSE 3: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_densest_4 = [model, history, pred, score_train, score_test, score_dev, '(t-4)STACKED 3 DENSE']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('STACKED DENSE 4: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
print(result_dense_st.describe().T.filter(like='loop', axis=0), 'Results for STACKED DENSE')
# fig.savefig('result_vanilla.png')
# --------------------------------------------------------------------------------------------------
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_vanilla_1 = [model, history, pred, score_train, score_test, score_dev, '(t-1)VANILLA LSTM']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('VANILLA 1: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_vanilla_2 = [model, history, pred, score_train, score_test, score_dev, '(t-2)VANILLA LSTM']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('VANILLA 2: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_vanilla_3 = [model, history, pred, score_train, score_test, score_dev, '(t-3)VANILLA LSTM']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('VANILLA 3: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_vanilla_4 = [model, history, pred, score_train, score_test, score_dev, '(t-4)VANILLA LSTM']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('VANILLA 4: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_stack_1 = [model, history, pred, score_train, score_test, score_dev, '(t-1)STACKED LSTM']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('STACKED 1: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_stack_2 = [model, history, pred, score_train, score_test, score_dev, '(t-2)STACKED LSTM']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('STACKED 2:Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_stack_3 = [model, history, pred, score_train, score_test, score_dev, '(t-3)STACKED LSTM']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('STACKED 3: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_stack_4 = [model, history, pred, score_train, score_test, score_dev, '(t-4)STACKED LSTM']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('STACKED 4: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_bidirect_1 = [model, history, pred, score_train, score_test, score_dev, '(t-1)BIDIRECTIONAL LSTM']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('BIDIRECTIONAL 1: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_bidirect_2 = [model, history, pred, score_train, score_test, score_dev, '(t-2)BIDIRECTIONAL LSTM']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('BIDIRECTIONAL 2: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_bidirect_3 = [model, history, pred, score_train, score_test, score_dev, '(t-3)BIDIRECTIONAL LSTM']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('BIDIRECTIONAL 3: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_bidirect_4 = [model, history, pred, score_train, score_test, score_dev, '(t-4)BIDIRECTIONAL LSTM']
## view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('BIDIRECTIONAL 4: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_bistacked_1 = [model, history, pred, score_train, score_test, score_dev,
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('BIDIRECTIONAL STACKED 1: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_bistacked_2 = [model, history, pred, score_train, score_test, score_dev,
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('BIDIRECTIONAL STACKED 2: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_bistacked_3 = [model, history, pred, score_train, score_test, score_dev,
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('BIDIRECTIONAL STACKED 3: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test, devX, y)
model_bistacked_4 = [model, history, pred, score_train, score_test, score_dev,
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('BIDIRECTIONAL STACKED 4: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
trainX = X_train_scaled_1.reshape(X_train_scaled_1.shape[0], X_train_scaled_1.shape[1], 1)
y_train = y_train_1
...
history = lstm_fit(trainX, y_train, model)
# make prediction
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test,
                                                       devX, y)
model_cnn_1 = [model, history, pred, score_train, score_test, score_dev, '(t-1)' + cnn_type]
# view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print(cnn_type + ' 1: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# Assign the train dataset
# reshape from [samples, timesteps] into [samples, timesteps, features]
trainX = X_train_scaled_2.reshape(X_train_scaled_2.shape[0], X_train_scaled_2.shape[1], 1)
y_train = y_train_2
...
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test,
                                                       devX, y)
model_cnn_2 = [model, history, pred, score_train, score_test, score_dev, '(t-2)' + cnn_type]
# view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print(cnn_type + ' 2: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# Assign the train dataset
# reshape from [samples, timesteps] into [samples, timesteps, features]
trainX = X_train_scaled_3.reshape(X_train_scaled_3.shape[0], X_train_scaled_3.shape[1], 1)
y_train = y_train_3
...
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test,
                                                       devX, y)
model_cnn_3 = [model, history, pred, score_train, score_test, score_dev, '(t-3)' + cnn_type]
# view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print(cnn_type + ' 3: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# Assign the train dataset
# reshape from [samples, timesteps] into [samples, timesteps, features]
trainX = X_train_scaled_4.reshape(X_train_scaled_4.shape[0], X_train_scaled_4.shape[1], 1)
y_train = y_train_4
...
pred, score_train, score_test, score_dev = calcPredict(df, model, trainX, y_train, testX, y_test,
                                                       devX, y)
model_cnn_4 = [model, history, pred, score_train, score_test, score_dev, '(t-4)' + cnn_type]
# view process
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print(cnn_type + ' 4: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
# View the result
print(result_cnn_dense.describe().T.filter(like=cnn_type, axis=0), 'Results for ' + cnn_type)
print(result_cnn_dense.describe().T.filter(like='test', axis=0), 'Results for ' + cnn_type)
    ...
    for n in grid_neurons:
        for d in grid_dropout:
            ...
            for r in range(repeats):
                # split
                X_train_3x, X_test_3x, y_train_3x, y_test_3x = \
                train_test_split(df_shift_3.drop(['(t)date_ym', '(t)target'], axis=1),
                df_shift_3['(t)target'],
                test_size=0.15,
                shuffle=True,
                random_state=None)
                ...
                train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
                test_mape = model.evaluate(testX, y_test, verbose=0)[1]
                print('Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
                      .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
                result_end.loc[r, 'fix_train_' + str(e) + 'eX' + str(n) + 'nX' + str(d) + 'd'] = train_mape
                result_end.loc[r, 'fix_test_' + str(e) + 'eX' + str(n) + 'nX' + str(d) + 'd'] = test_mape
            K.clear_session()
print('DONE!')
# summarize results
...
for n in grid_neurons:
    for f in grid_filters:
        for k in grid_kernel:
            for p in grid_pool:
                for d in grid_dropout:
                    model = cnn_2dense(trainX, num_neuron=n, num_filter=f, kernel=k, pool=p, dropout=d)
                    print('neurons={ne} : filter={fi} : kernel={ke} : polling={po} : dropout={do}'
                          .format(ne=n, fi=f, ke=k, po=p, do=d))
                    for r in range(repeats):
                        lstm_fit(trainX, y_train, model)
                        train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
                        test_mape = model.evaluate(testX, y_test, verbose=0)[1]
                        print(cnn_type + ' 3: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
                              .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
                        result_cnn_tune2.loc[r, cnn_type + '(t-3)train_' + str(n) + 'nX' + str(f) + 'fX' \
                                             + str(k) + 'kX' + str(p) + 'pX' + str(d) + 'd'] = train_mape
                        result_cnn_tune2.loc[r, cnn_type + '(t-3)test_' + str(n) + 'nX' + str(f) + 'fX' \
                                             + str(k) + 'kX' + str(p) + 'pX' + str(d) + 'd'] = test_mape
                    K.clear_session()
...
result_cnn_tune2[result_cnn_tune2 != 100].dropna().filter(like='test', axis=1).boxplot(figsize=(14, 7), rot=90)
print(result_cnn_tune2.describe().T.filter(like='test', axis=0).sort_values(by=['50%']))
print(result_cnn_tune2.describe().T.filter(like='50fX10', axis=0).sort_values(by=['75%']))
...
for d in grid_drop:
    for rd in grid_recdrop:
        ...
        for r in range(repeats):
            # Place the rigth (best) model
            model = lstm_bidirect(num_neuron=500, alphalrelu=0.5, dropout=d, recurdropout=rd)
            lstm_fit(model, num_epoch=50)
            train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
            test_mape = model.evaluate(testX, y_test, verbose=0)[1]
            print('Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
                  .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
            result_drop.loc[r, 'train_' + str(d) + 'dropX' + str(rd) + 'recdrop'] = train_mape
            result_drop.loc[r, 'test_' + str(d) + 'dropX' + str(rd) + 'recdrop'] = test_mape
            K.clear_session()
# summarize results
...
for rd in grid_recdrop:
    for e in grid_epochs:
        for n in grid_neurons:
            print('rec_dropout={rdp} : epochs={ep} : neurons={ne}'.format(rdp=rd, ep=e, ne=n))
            for r in range(repeats):
                # Place the rigth (best) model
                model = lstm_bidirect(num_neuron=n, alphalrelu=0.5, dropout=0.1, recurdropout=rd)
                lstm_fit(model, num_epoch=e)
                train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
                test_mape = model.evaluate(testX, y_test, verbose=0)[1]
                print('Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
                      .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
                result_den.loc[r, 'train_' + str(rd) + 'recdrop_' + str(e) + 'eX' + str(n) + 'n'] = train_mape
                result_den.loc[r, 'test_' + str(rd) + 'recdrop_' + str(e) + 'eX' + str(n) + 'n'] = test_mape
                K.clear_session()
# summarize results
...
for a in grid_activ:
    ...
    for r in range(repeats):
        # Place the rigth (best) model
        model = lstm_bidirect(num_neuron=500, alphalrelu=0.5, out_activ=a,
                              dropout=0.1, recurdropout=0.3)
...
def lstm_vanilla_lrelu(num_neuron=500, activation='linear', alphalrelu=0.3, \
                       dropout=0, recurdropout=0):
    # design VANILLA LSTM
    model = Sequential()
...
def lstm_vanilla_prelu(num_neuron=500, activation='linear', \
                       dropout=0, recurdropout=0):
    # design VANILLA LSTM
    model = Sequential()
    model.add(LSTM(num_neuron
...
for a in grid_alpha:
    for r in range(result_range):
        ...
        train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
        test_mape = model.evaluate(testX, y_test, verbose=0)[1]
        print('LeakyReLU: alpha{al}: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
              .format(al=a, rep=r + 1, trainmape=train_mape, testmape=test_mape))
...
for r in range(result_range):
    ...
    train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
    test_mape = model.evaluate(testX, y_test, verbose=0)[1]
    print('ParamReLU: Repeat={rep}: TrainMAPE={trainmape} TestMAPE={testmape}'
          .format(rep=r + 1, trainmape=train_mape, testmape=test_mape))
                ...
                for p in [3, 4, 5]:
                    for d in [0.0, 0.2]:
                        ...
                        for r in range(result_range):
                            ...
                            X_scaled_3 = scaler.transform(X_3)
                            # assign
                            trainX = X_train_scaled_3x.reshape(X_train_scaled_3x.shape[0], X_train_scaled_3x.shape[1],
                                                               1)
                            y_train = y_train_3x
                            testX = X_test_scaled_3x.reshape(X_test_scaled_3x.shape[0], X_test_scaled_3x.shape[1], 1)
                            y_test = y_test_3x
                            devX = X_scaled_3.reshape(X_scaled_3.shape[0], X_scaled_3.shape[1], 1)
                            y = y_3
                            # fit
                            model = cnn_2denseX(num_neuron=n, num_filter=f, kernel=k, pool=p, dropout=d)
                            history = lstm_fit(trainX, y_train, model, num_epoch=e, val_split=0.15)
                            train_mape = model.evaluate(trainX, y_train, verbose=0)[1]
                            test_mape = model.evaluate(testX, y_test, verbose=0)[1]
                            print(
                                'Epochs={ep} : neurons={ne} : filter={fl} : kernel={ke} : pool={po}: drop={dr}: Repeat={rep} \n'
                                'TrainMAPE={trainmape} TestMAPE={testmape}'
                                .format(ep=e, ne=n, fl=f, ke=k, po=p, dr=d, rep=r + 1, trainmape=train_mape,
                                        testmape=test_mape))
                            step = str(e) + 'e_' + str(n) + 'n_' + str(f) + 'f_' + str(k) + 'k_' + str(p) + 'p' + str(
                                d) + 'd'
                            result_randsplitX.loc[r, cnn_type + '(t3)train_' + step] = train_mape
                            result_randsplitX.loc[r, cnn_type + '(t3)test_' + step] = test_mape
                            result_randsplitX.loc[r, cnn_type + '(t3)ratio_' + step] = test_mape / train_mape
                            # predict
                            pred, score_train, score_test, score_dev = calcPredict(df, model,
                                                                                   trainX, y_train,
                                                                                   testX, y_test,
                                                                                   devX, y)
                            # save
                            model_randsplit = [model, history, pred, score_train, score_test, score_dev, cnn_type]
                            # view
...
print(result_randsplitX.describe().T.filter(like='test', axis=0).sort_values(by=['50%']),
      'Results for RANDOM SPLIT in loop')
print(result_randsplitX.describe().T.filter(like='ratio', axis=0).sort_values(by=['mean']),
      'Results for RANDOM SPLIT in loop')

print(result_randsplitX.describe().T.filter(like='test', axis=0).sort_values(by=['min']))

result_randsplitX[['Conv2Dense(t-3)train_200e_1000n_25f_20k_5p',
                   'Conv2Dense(t-3)test_200e_1000n_25f_20k_5p']].plot.line()
